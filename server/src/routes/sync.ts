...
router.get(
  ...
  asyncHandler(async (req, res) => {
    ...
    const categoryWhere: Prisma.CategoryWhereInput = { ownerId: req.user!.id };
    const tagWhere: Prisma.TagWhereInput = { ownerId: req.user!.id };
    const snippetWhere: Prisma.SnippetWhereInput = { ownerId: req.user!.id };
